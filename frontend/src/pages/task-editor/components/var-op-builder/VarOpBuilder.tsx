...
const OPS_BY_TYPE: Record<string, OpDef[]> = {
  ...
  number: [
    ...
    { key: "mul",    title: "乘法 ×n",    desc: "var * n",                                  expr: "{var*?}",   arg: { label: "数值", type: "number" } },
    { key: "div",    title: "除法 ÷n",    desc: "var / n",                                  expr: "{var/?}",   arg: { label: "数值", type: "number" } },
    { key: "fdiv",   title: "整除 //n",   desc: "var // n (向下取整)",                       expr: "{var//?}",  arg: { label: "数值", type: "number" } },
    { key: "mod",    title: "取模 %n",    desc: "var % n (求余数)",                           expr: "{var%?}",   arg: { label: "数值", type: "number" } },
