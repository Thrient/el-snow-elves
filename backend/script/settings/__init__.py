...
def register(api: Api) -> None:
    ...
    from script.settings.AppConfig import load_merged_settings, save_user_settings
    ...
    api.on("API:SETTINGS:LOAD", load_merged_settings)
    api.on("API:SETTINGS:SAVE", save_user_settings)
